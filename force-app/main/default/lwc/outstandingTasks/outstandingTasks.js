...
export default class OutstandingTasks extends NavigationMixin(LightningElement) {
	@api recordId;
	@track tasks;
	@track visible;
	count;
    ...
    @wire(getTasks, {userId: userId, recordId: null}) wiredOutstandingTasks({data, error}){
